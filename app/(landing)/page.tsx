...
const mockThreads = [
  {
    id_string: "1",
    prfile_image_url_https:
      "https://avatars.githubusercontent.com/u/85483006?v=4",
    thread: false,
    name: "ReacherX founder",
    screen_name: "ReacherXfounder",
    tweet_created_at: "2023-03-01T00:00:00.000Z",
    full_text: `1/4
  ...
  return (
    <div className="space-y-12 px-4 py-6 md:space-y-48 md:px-28 md:pb-52 md:pt-12">
      ...
      >
        ...
        <TweetCard {...mockThreads[0]} className="px-0" size="lg" />
      </section>
