...
export default defineSchema({
  ...
  /**
   * Signed post-cutover deltas for workspaceStats. Existing workspaceStats rows
   * remain the immutable baseline until the later narrow/cleanup phase.
   */
  workspaceStatsStripes: defineTable({
    workspaceId: v.id("workspaces"),
    userId: v.id("users"),
    stripe: v.number(),
    totalProspectsCount: v.number(),
    ...
    plansGeneratedCount: v.number(),
    readyQualifiedEnrichedCount: v.number(),
    actionableReadyCount: v.number(),
    qualificationScoreSum: v.number(),
    qualificationScoreCount: v.number(),
    avgQualificationScore: v.number(),
    pendingNotificationCount: v.number(),
    updatedAt: v.number(),
  }).index("by_workspace_and_stripe", ["workspaceId", "stripe"]),
  ...
  /** Signed post-cutover deltas for workspaceAnalyticsDaily. */
  workspaceAnalyticsDailyStripes: defineTable({
    workspaceId: v.id("workspaces"),
    dayStartUtcMs: v.number(),
    dayKey: v.string(),
    stripe: v.number(),
    ...
    qualificationDisqualifiedCount: v.number(),
    actionableReadyCount: v.number(),
    qualifiedEventsCount: v.number(),
    disqualifiedEventsCount: v.number(),
    readyEventsCount: v.number(),
    twitterProspectsCount: v.number(),
    linkedInProspectsCount: v.number(),
    contactedEventsCount: v.number(),
    respondedEventsCount: v.number(),
    ...
    failedTasksCount: v.number(),
    hourlyNewProspectsCounts: hourlyAnalyticsCountsValidator,
    hourlyReachedContactedProspectsCounts: hourlyAnalyticsCountsValidator,
    hourlyReachedInProgressProspectsCounts: hourlyAnalyticsCountsValidator,
    hourlyReachedConvertedProspectsCounts: hourlyAnalyticsCountsValidator,
    hourlyFitScore0To49Counts: hourlyAnalyticsCountsValidator,
    hourlyFitScore50To69Counts: hourlyAnalyticsCountsValidator,
    hourlyFitScore70To79Counts: hourlyAnalyticsCountsValidator,
    hourlyFitScore80To100Counts: hourlyAnalyticsCountsValidator,
    hourlyQualificationQualifiedCounts: hourlyAnalyticsCountsValidator,
    hourlyQualificationDisqualifiedCounts: hourlyAnalyticsCountsValidator,
    hourlyActionableReadyCounts: hourlyAnalyticsCountsValidator,
    hourlyTwitterProspectsCounts: hourlyAnalyticsCountsValidator,
    hourlyLinkedInProspectsCounts: hourlyAnalyticsCountsValidator,
    hourlyContactedEventsCounts: hourlyAnalyticsCountsValidator,
    hourlyRespondedEventsCounts: hourlyAnalyticsCountsValidator,
    hourlyDraftPlansCounts: hourlyAnalyticsCountsValidator,
    hourlyPendingApprovalTasksCounts: hourlyAnalyticsCountsValidator,
    ...
    hourlyFailedTasksCounts: hourlyAnalyticsCountsValidator,
    updatedAt: v.number(),
  }).index("by_workspace_day_and_stripe", [
    "workspaceId",
    "dayStartUtcMs",
    "stripe",
  ]),
  ...
  /** Signed post-cutover deltas for workspaceAgentOpsDaily. */
  workspaceAgentOpsDailyStripes: defineTable({
    workspaceId: v.id("workspaces"),
    dayStartUtcMs: v.number(),
    dayKey: v.string(),
    stripe: v.number(),
    ...
    suggestionsRejectedCount: v.number(),
    memoriesWrittenCount: v.number(),
    highImpactMemoriesCount: v.number(),
    memoryImpactScoreSum: v.number(),
    memoryConfidenceSum: v.number(),
    eventsReceivedCount: v.number(),
    failedEventsCount: v.number(),
    ...
    hourlySuggestionsRejectedCounts: hourlyAnalyticsCountsValidator,
    hourlyMemoriesWrittenCounts: hourlyAnalyticsCountsValidator,
    hourlyHighImpactMemoriesCounts: hourlyAnalyticsCountsValidator,
    hourlyMemoryImpactScoreSums: hourlyAnalyticsCountsValidator,
    hourlyMemoryConfidenceSums: hourlyAnalyticsCountsValidator,
    hourlyEventsReceivedCounts: hourlyAnalyticsCountsValidator,
    hourlyFailedEventsCounts: hourlyAnalyticsCountsValidator,
